...
<html>
 <head>
  ...
  <title>LOGIN</title>
  <nav class="navbar py-5 navbar-dark bg-primary justify-content-center">
    ...
    <section>
     ...
     <div class="card border-0 shadow">
      <div class="card body">
      <svg class="max-auto" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16" class="bi bi-align-center">
