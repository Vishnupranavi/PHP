<?php
    class HRModel extends DataBase
   
     { 
     public function insertJob($stackName,$description,$startDate,$endDate)
     {
         echo $insert= "INSERT INTO JobDescription(Stack,description,StartDate,EndDate)VALUES('".$stackName."','".$description."','".$startDate."','".$endDate."')";
